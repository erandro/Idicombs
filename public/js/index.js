$(document).ready(function () {
  ...
  function showMutiSearchedIdioms(multiIdiomObject) {
    ...
    multiIdiomObject.forEach(function (element) {
      multiIdiomHolder.append(`<div class="multi_idiom_card"
      data-id="${element.id}"
      ...
      data-languageid="${element.LanguageId}">
              <div class="idiom-card-header">
                <h3 class="idiom-card-title">${element.origin_idiom}</h3>
              </div>
              <div class="idiom-card-body">
                <p class="idiom-card-title">Meaning:</p>
                <p class="idiom-card-text">${element.meaning}</p>
              </div>
          </div>`)
    });
  };
